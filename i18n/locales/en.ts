export const en = {
  ...
  npcs: {
    ...
    createNamePrompt: "What's your NPC called?",
    ...
    challengeRatingLabel: 'Challenge Rating',
    challengeRatingInfo: 'Challenge Rating Information',
    hitPoints: 'Hit Points',
    hitPointsLimit: 'Hit Point Maximum',
    hitPointsLimitTemporary: 'Temporary Hit Point Maximum',
    temporaryHitPoints: 'Temporary Hit Points',
    senses: 'Senses',
    couldNotLoadNpcs: 'Could not load NPCs',
    couldNotLoadNpc: 'Could not load NPC',
