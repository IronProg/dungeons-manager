export const pt = {
  ...
  profile: {
    nickname: 'Apelido',
    email: 'E-mail',
    discriminator: 'Código de usuário',
    edit: 'Editar',
  ...
  npcs: {
    ...
    createNamePrompt: 'Como seu NPC se chama?',
    ...
    challengeRatingLabel: 'Nível de Desafio',
    challengeRatingInfo: 'Informações do Nível de Desafio',
    hitPoints: 'Pontos de Vida',
    hitPointsLimit: 'Máximo de Pontos de Vida',
    hitPointsLimitTemporary: 'Máximo Temporário de Pontos de Vida',
    temporaryHitPoints: 'Pontos de Vida Temporários',
    senses: 'Sentidos',
    couldNotLoadNpcs: 'Não foi possível carregar os NPCs',
    couldNotLoadNpc: 'Não foi possível carregar o NPC',
  ...
  validation: {
    ...
    numberMin: 'Deve ser no mínimo %{min}',
    numberMax: 'Deve ser no máximo %{max}',
    stringMin: 'Deve ter no mínimo %{min} caracteres',
    stringMax: 'Deve ter no máximo %{max} caracteres',
    arrayMin: 'Deve ter no mínimo %{min} itens',
    arrayMax: 'Deve ter no máximo %{max} itens',
    exactLength: 'Deve ter exatamente %{length} itens',
    tooSmall: 'Deve ser no mínimo %{min}',
    tooBig: 'Deve ser no máximo %{max}',
    invalidEmail: 'Não é um email válido',
    invalidOption: 'Opção inválida',
    invalidFormat: 'Formato inválido',
    startsWith: 'Deve começar com "%{prefix}"',
    endsWith: 'Deve terminar com "%{suffix}"',
    includes: 'Deve conter "%{text}"',
  },
  tables: {
    table: 'Mesa',
    title: 'Mesas',
    ...
    requestSent: 'Pedido de acesso enviado.',
    inviteCodeCopied: 'Código de convite copiado.',
    shareInvite: 'Compartilhar convite',
    inviteMessage: 'Entre na minha mesa no Dungeons Manager:',
  ...
  tableRequests: {
    ...
    refuse: 'Recusar',
    cancel: 'Cancelar',
    noRequests: 'Nenhum convite ou pedido pendente.',
    searchPlaceholder:
      'Busque por apelido com código (ex: Nick#1234) ou e-mail exato.',
    invited: 'Convite enviado com sucesso!',
    requestAccepted: 'Pedido aceito.',
    requestRefused: 'Pedido recusado.',
